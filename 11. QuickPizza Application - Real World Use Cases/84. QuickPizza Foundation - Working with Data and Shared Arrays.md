**Definition:** Shared Arrays are used to share data among all virtual users during the execution in read-only format.

Run the script "k6/foundations/09.data.js" file.
